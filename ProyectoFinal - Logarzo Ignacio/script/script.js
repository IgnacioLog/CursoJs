...
/* --------- */
let menuItems,
    rowAdidas = document.querySelector("#row-adidas"),
    rowNike = document.querySelector("#row-nike"),
    rowPuma = document.querySelector("#row-puma"),
    rowUmbro = document.querySelector("#row-umbro"),
...
function createMenuCard(type, description, price, available, source) {
    ...
    switch (type) {
        case "Adidas":
            rowAdidas.appendChild(divCol);
            break;
        case "Nike":
            rowNike.appendChild(divCol);
            break;
        case "Puma":
            rowPuma.appendChild(divCol);
            break;
        case "Umbro":
            rowUmbro.appendChild(divCol);
            break;
    }
...
function createSettingsRow(type, description, price, available, source) {
    ...
    option1.value = "Adidas";
    option1.textContent = "Adidas";
    inputType.appendChild(option1);
    let option2 = document.createElement("option");
    option2.value = "Nike";
    option2.textContent = "Nike";
    inputType.appendChild(option2);
    let option3 = document.createElement("option");
    option3.value = "Puma";
    option3.textContent = "Puma";
    inputType.appendChild(option3);
    let option4 = document.createElement("option");
    option4.value = "Umbro";
    option4.textContent = "Umbro";
